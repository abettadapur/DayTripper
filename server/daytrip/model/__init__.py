...
categories.append(Category('attraction', ['localflavor','tours', 'parks','shopping'],'fun'))
categories.append(Category('nightlife', ['bars','beergardens','comedyclubs','jazzandblues','karaoke','poolhalls', 'coffee'],''))
